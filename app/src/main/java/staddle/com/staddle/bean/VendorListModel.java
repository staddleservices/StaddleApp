...
public class VendorListModel{
    ...
    private String work_certifaction;
    ...
    public String getWork_certifaction() {
        return work_certifaction;
    }

    public void setWork_certifaction(String work_certifaction) {
        this.work_certifaction = work_certifaction;
    }
